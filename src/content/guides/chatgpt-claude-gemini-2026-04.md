...
readTimeMin: 10
tags: ["ChatGPT", "Claude", "Gemini", "GPT-5.5", "Opus 4.7", "Gemini 3.1", "対話AI"]
...
**こんな人におすすめ**：初めてAIを使う人・幅広い用途を1本で済ませたい人。コーディングメインなら Codex プランが最適。
...
- Deep Research Max の調査精度が抜群、MCP 連携でデータソース統合
- Gmail / Docs / Sheets / Photos との統合
- 2Mトークンの超長文、動画入力も可能
- API 価格が圧倒的に安い（$1.25/$5 per M tokens）
- Veo 3.1 動画生成が個人無料化、Sora 終了の代替最有力
- Gemini for Home でスマートホーム連携
