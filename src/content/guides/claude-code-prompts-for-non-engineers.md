...
description: "Claude Code を使って個人サイト・業務自動化・スクリプトを作りたい非エンジニア向けに、編集部が実際に使った『すぐ動く神プロンプト』5選を公開。プロジェクト設計・Content Collections・SEO 完璧化・記事テンプレ化・キーワードクラスター生成まで網羅。"
...
tldr: "Claude Code に投げるべき5つの『すぐ動く』神プロンプトを実例つきで公開。①プロジェクト設計、②Content Collections のスキーマ設計、③SEO完璧化、④記事のテンプレート化、⑤キーワードクラスター一括生成。各プロンプトに『使うときのコツ』『カスタマイズ例』『実行結果』『ありがちな失敗』を詳述。編集部はこの5本だけで6日でメディアサイトを立ち上げ、Google検索順位3〜5位を獲得しました。"
faq:
...
「Claude Code に何を頼めばいいか分からない」——課金後の最大のつまずきです。本記事では、編集部が **2026年4月20日にサイトを立ち上げ、6日で Google 検索順位3〜5位を取った**ときに実際に投げた**5つの神プロンプト**を、**そのままコピペで使える形**で公開します。
