...
faq:
  ...
  - q: "どのツールから始めるべき？"
    a: "Claude Pro（月$20）+ Claude Code が最初の1本として最有力。CLI 操作に抵抗があれば、Cursor Pro（月$20）の対話型 IDE が初心者向け。GitHub Copilot は『コード補完』なので、ある程度コードが書ける人向けです。"
  - q: "失敗しても大丈夫？"
...
- **Claude Code（Pro $20/月）+ Cursor Pro 併用**が初心者最有力
