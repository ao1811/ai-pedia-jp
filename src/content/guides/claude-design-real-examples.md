...
「Claude Design に何を頼めばいいか分からない」——課金後の最大のつまづきポイントは、**具体的な業務シナリオが思い浮かばないこと**です。本記事では Anthropic 公式情報・主要メディアの解説・編集部の利用所感をもとに、**10の業務事例**を **そのままコピペで使える完成プロンプト**つきで紹介します。
