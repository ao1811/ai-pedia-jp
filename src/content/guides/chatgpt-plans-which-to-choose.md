...
readTimeMin: 8
tags: ["ChatGPT", "プラン", "コスパ", "GPT-5.5", "Codex", "2026"]
amazonProducts: ["chatgpt-strongest-work", "chatgpt-gpts-book"]
tldr: "2026年4月時点：迷ったら Plus（¥3,000/月）で GPT-5.5 を使うのが基本。コーディング業務メインなら新設の Codex プラン（¥16,800/月）が最適。Pro（¥30,000/月）は Sora 終了で価値が低下し、Codex への移行が増えている。Free は GPT-5（軽量版）のみで GPT-5.5 不可。Free→Plus の差は日常使用で元が取れます。"
faq:
...
| | Free | Plus | **Codex（新設）** | Pro |
|---|---|---|---|---|
| 料金 | ¥0 | ¥3,000/月 | ¥16,800/月 | ¥30,000/月 |
| **GPT-5.5（最新）** | ✕ | ○（80msg/3h） | **○（ほぼ無制限）** | ○（無制限） |
| GPT-5（軽量版） | ○ | ○ | ○ | ○ |
| 画像生成 | 1日3枚程度 | 無制限 | 無制限 | 無制限 |
| 動画生成（Sora） | ✕ | ✕（4/26終了） | ✕ | ✕（4/26終了） |
| Deep Research | 月5回 | 月100回 | 標準 | 無制限 |
| Codex CLI / IDE 拡張 | △ | △ 制限あり | **○ 無制限** | ○ 無制限 |
| Computer Use | △ | △ 制限あり | **○ Codex Cloud** | ○ 全機能 |
| 音声会話 | ○ | ○ | ○ | ○（プロ版） |
| 優先アクセス | ✕ | ○ | ○ | ◎ |
| API クレジット | ✕ | ✕ | ✕ | $100分付属 |
...
## 3. Codex プラン（¥16,800・新設）：エンジニアの新しい正解

2026年4月9日に新設された **エンジニア向けコーディング特化プラン**。Pro より44%安く、Plus より圧倒的に高機能。

### Codex プランが最適な人

- **コーディング業務がメイン** — GPT-5.5 がほぼ無制限
- **Cursor / Claude Code に課金している** — 乗り換え or 併用で AI コーディング強化
- **Plus でコーディングに限界を感じる** — 制限なしの快適さ
- **Pro 加入者で Sora を使わない** — Codex 移行で月¥13,200節約

### Codex で開放される機能

- GPT-5.5 ほぼ無制限利用
- Codex CLI（公式コマンドラインツール）
- VS Code / JetBrains / Cursor の IDE 拡張
...
月額 ¥30,000 は個人には高額。さらに **2026年4月26日の Sora 終了で主要訴求機能が消失** したため、現状の価値は限定的です。

### Pro が真価を発揮する用途（限定的）

- **API 開発者** — $100分のクレジットが付く（実質値引き）
- **Research 業務** — Deep Research 無制限が必須
